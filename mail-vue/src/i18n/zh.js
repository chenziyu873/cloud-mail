const zh = {
    ...
    settings: '设置',
    mailboxPool: '邮箱号池',
    targetUserPool: '目标用户号池',
    campaign: '批量群发',
    availablePairs: '当前可用发送对',
    startCampaign: '启动群发任务',
    campaignProgress: '发送进度',
    addEmail: '添加邮箱',
    importEmails: '批量导入',
    addSuccessMsg: '添加成功',
    allowRepeatSend: '允许给单个目标重复发送',
    repeatCount: '每个目标发送次数',
    batchDelay: '批次发送间隔 (ms)',
    taskLogs: '任务执行日志',
    fromAccount: '发件账号',
    toTarget: '目标用户',
    executionTime: '执行时间',
    ...
    content: '邮件内容',
    batchGenerate: '批量生成',
    importSuccess: '导入完成，共 {count} 个',
    poolManage: '号池管理',
    genCount: '生成数量',
    prefix: '邮箱前缀',
    suffixLength: '随机长度',
    batchLimit: '单次生成上限为100个',
    generateSuccess: '生成成功',
    clearPool: '清空号池',
    copyAll: '复制全部',
    confirmClearPool: '确定要清空所有号池邮箱吗？',
    analytics: '分析页',
    allUsers: '用户列表',
    allMail: '全部邮件',
    permissions: '权限控制',
