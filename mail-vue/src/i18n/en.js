const en = {
    ...
    starred: 'Starred',
    settings: 'Settings',
    mailboxPool: 'Mailbox Pool',
    targetUserPool: 'Target User Pool',
    campaign: 'Batch Campaign',
    startCampaign: 'Start Campaign',
    availablePairs: 'Available Pairs',
    campaignProgress: 'Campaign Progress',
    addEmail: 'Add Email',
    importEmails: 'Batch Import',
    addSuccessMsg: 'Added Successfully',
    allowRepeatSend: 'Allow repeated sending to the same target',
    repeatCount: 'Repeat Count (per target)',
    batchDelay: 'Batch Delay (ms)',
    ...
    importSuccess: 'Imported {count} emails',
    poolManage: 'Pool Management',
    genCount: 'Count',
    prefix: 'Prefix',
    suffixLength: 'Random Length',
    batchLimit: 'Maximum 100 per batch',
    generateSuccess: 'Generated successfully',
    clearPool: 'Clear Pool',
    copyAll: 'Copy All',
    confirmClearPool: 'Are you sure you want to clear all pool emails?',
    analytics: 'Analytics',
    allUsers: 'All Users',
    allMail: 'All Mail',
    permissions: 'Role',
